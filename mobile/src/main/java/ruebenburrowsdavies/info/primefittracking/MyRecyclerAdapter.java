...
public class MyRecyclerAdapter extends RecyclerView.Adapter<MyRecyclerAdapter.CustomViewHolder>{
    ...
    class MyOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            int itemPosition = news_one.mRecyclerView.getChildPosition(v);
            ...
            // GET THE LINK STORED FOR THAT VALUE AND PASS IT BELOW

            final String FinalLink = "http://www.telegraph.co.uk" + feedItem.getHtmlLink();
            // START A WEB BROWSER VIEW OF THAT LINK
